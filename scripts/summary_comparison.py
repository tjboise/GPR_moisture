...
resA_raw = np.load('../results/results_methodA.npy', allow_pickle=True).item()
...
resB = np.load('../results/results_methodB.npy', allow_pickle=True).item()
r2_B  = np.array(resB['r2'])
rms_B = np.array(resB['rmse'])

resC_raw = np.load('../results/results_methodC.npy', allow_pickle=True).item()
...
resD = np.load('../results/results_methodD.npy', allow_pickle=True).item()
r2_D  = np.array(resD['r2'])
rms_D = np.array(resD['rmse'])

resE = np.load('../results/results_methodE.npy', allow_pickle=True).item()
...
plt.tight_layout()
plt.savefig('../results/fig_summary_comparison.png', dpi=150, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('../results/fig_summary_avg_r2.png', dpi=150, bbox_inches='tight')
plt.close()
